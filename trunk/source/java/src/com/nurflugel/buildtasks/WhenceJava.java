...
// --------------------------- main() method ---------------------------
     ...
     */
    private boolean isArchiveFile(String classpathElement) { return classpathElement.endsWith(".jar") || classpathElement.endsWith(".zip"); }
...
// -------------------------- INNER CLASSES --------------------------
    ...
    private class SearchResult
    {
        ...
        public String getFullClassPathName() { return fullClassPathName; }
    }
}
